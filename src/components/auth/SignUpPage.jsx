...
function handleAuthError(err) {
  switch (err.code) {
    ...
    default: return err.message || 'An unexpected error occurred during sign up.';
  }
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginTop: '22px', fontSize: '13px', color: 'var(--text-secondary, #CBD5E1)' }}>
